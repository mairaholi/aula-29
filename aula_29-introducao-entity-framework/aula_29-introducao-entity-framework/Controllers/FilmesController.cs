...
namespace aula_29_introducao_entity_framework.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataLancamento,Duracao")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataLancamento,Duracao")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
